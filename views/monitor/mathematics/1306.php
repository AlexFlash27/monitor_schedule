...
$fs_block = 'О.Г. Власова'; //ОТВЕТСТВЕННЫЙ ЗА ПОЖАРНУЮ БЕЗОПАСНОСТЬ
...
<div class="container-fluid">
    <div class="row">
        <div class="room_block">
            <div class="room_number"><img id="r_number" src=<?= Yii::getAlias('@web') . "/img/1306.png" ?>></div>
