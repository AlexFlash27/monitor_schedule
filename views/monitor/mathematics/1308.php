...
$fs_block = 'О.В. Нуртдинова'; //ОТВЕТСТВЕННЫЙ ЗА ПОЖАРНУЮ БЕЗОПАСНОСТЬ
...
<div class="container-fluid">
    <div class="row">
        <div class="room_block">
            <div class="room_number"><img id="r_number" src=<?= Yii::getAlias('@web') . "/img/1308.png" ?>></div>
